        ...
        if ((k1 * s1 != n) && (k2 * s2 != n) && (k3 * s3 != n))
        {
            if (k1 == 0)
            {
                if (k2 > k3)
                {
                    ...
                    {
                        if (i < k3 * s3) F1[i] = F3[i];
                        else F1[i] = F2[i - k3 * s3];
                    }
                    sort(F1, k1 * s1);
                ...
                else
                {
                    ...
                    for (int i = 0; i < k1 * s1; i++)
                    {
                        if (i < k2 * s2) F1[i] = F2[i];
                        else F1[i] = F3[i - k2 * s2];
                    }
                    sort(F1, k1 * s1);
            ...
            else if (k2 == 0)
            {
                if (k1 > k3)
                {
                    ...
                    {
                        if (i < k3 * s3) F2[i] = F3[i];
                        else F2[i] = F1[i - k3 * s3];
                    }
                    sort(F2, k2 * s2);
                ...
                else
                {
                    ...
                    for (int i = 0; i < k2 * s2; i++)
                    {
                        if (i < k1 * s1) F2[i] = F1[i];
                        else F2[i] = F3[i - k1 * s1];
                    }
                    sort(F2, k2 * s2);
            ...
            else if (k3 == 0)
            {
                if (k1 > k2)
                {
                    ...
                    {
                        if (i < k2 * s2) F3[i] = F2[i];
                        else F3[i] = F1[i - k2 * s2];
                    }
                    sort(F3, k3 * s3);
                ...
                else
                {
                    ...
                    for (int i = 0; i < k3 * s3; i++)
                    {
                        if (i < k1 * s1) F3[i] = F1[i];
                        else F3[i] = F2[i - k1 * s1];
                    }
