...
public:
    ...
    friend fstream& operator>>(fstream&in, Money&t);
    friend fstream& operator<<(fstream&out, const Money&t);
...
fstream&operator>>(fstream&in, Money&t) {
    in >> t.rub;
    in >> t.penny;
    return in;
}

fstream&operator<<(fstream&out, const Money&t) {
    out << t.rub << "\n" << t.penny << "\n";
    return out;
}
